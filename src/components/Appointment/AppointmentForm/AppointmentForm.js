...
const AppointmentForm = ({ modalIsOpen, closeModal, appointmentOn, date }) => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://secret-savannah-81717.herokuapp.com/addAppointment', {
            method: 'POST',
    ...
    return (
        <div>
            ...
            >
                ...
                <h5 className="text-center text-brand">{appointmentOn}</h5>
                ...
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group text-right">
                        <button type="submit" className="btn btn-brand text-white px-5">Send</button>
                    </div>
                </form>
            </Modal>
        </div>
